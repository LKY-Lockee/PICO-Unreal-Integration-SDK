...
#if PLATFORM_ANDROID
extern "C" JNIEXPORT void  JNICALL Java_com_epicgames_ue4_GameActivity_JavaToCBindTobService(JNIEnv * env, jclass clazz, jboolean Result)
{
	if (Result == JNI_TRUE)
	{
...
#if PLATFORM_ANDROID
extern "C" JNIEXPORT void  JNICALL Java_com_epicgames_ue4_GameActivity_JavaToCSwitchSystemFunctionCallback(JNIEnv * env, jclass clazz, int Result)
{
...
#if PLATFORM_ANDROID
extern "C" JNIEXPORT void  JNICALL Java_com_epicgames_ue4_GameActivity_JavaToCopenLargeSpaceQuickModeCallback(JNIEnv * env, jclass clazz, int Result)
{
...
#if PLATFORM_ANDROID
extern "C" JNIEXPORT void  JNICALL Java_com_epicgames_ue4_GameActivity_JavaToCsetOriginOfLargeSpaceQuickModeCallback(JNIEnv * env, jclass clazz, int Result)
{
...
#if PLATFORM_ANDROID
extern "C" JNIEXPORT void  JNICALL Java_com_epicgames_ue4_GameActivity_JavaToCsetBoundaryOfLargeSpaceQuickModeCallback(JNIEnv * env, jclass clazz, int Result)
{
...
int UPICOEnterpriseFunctionLibrary::PE_ShowGlobalMessageDialog(UTexture2D* icon, FString title, FString body, int64 time, int gap, int position)
{
	...
	if (icon && icon->GetPixelFormat() == EPixelFormat::PF_B8G8R8A8)
	{
		...
		FTexture2DMipMap* Mip0 = &icon->PlatformData->Mips[0];
...
#if PLATFORM_ANDROID
extern "C" JNIEXPORT void  JNICALL Java_com_epicgames_ue4_GameActivity_JavaToCScanQRCodeCallback(JNIEnv * env, jclass clazz, jstring Msg)
{
...
#if PLATFORM_ANDROID
extern "C" JNIEXPORT void  JNICALL Java_com_epicgames_ue4_GameActivity_JavaToCOnOnfflineUpdateStatusChangedCallback(JNIEnv * env, jclass clazz, int statusCode, float percent)
{
	UPICOEnterpriseFunctionLibrary::OnfflineUpdateStatusChangedDelegate.ExecuteIfBound(statusCode, percent);
}

extern "C" JNIEXPORT void  JNICALL Java_com_epicgames_ue4_GameActivity_JavaToCOnOnfflineUpdateCompleteCallback(JNIEnv * env, jclass clazz, int errorCode, jstring errorMsg)
{
...
#if PLATFORM_ANDROID
extern "C" JNIEXPORT void  JNICALL Java_com_epicgames_ue4_GameActivity_JavaToCOnUpdateStatusChangedCallback(JNIEnv * env, jclass clazz, int statusCode, float percent)
{
	UPICOEnterpriseFunctionLibrary::OnUpdateStatusChangedDelegate.ExecuteIfBound(statusCode, percent);
}

extern "C" JNIEXPORT void  JNICALL Java_com_epicgames_ue4_GameActivity_JavaToCOnUpdateCompleteCallback(JNIEnv * env, jclass clazz, int errorCode, jstring errorMsg)
{
...
#if PLATFORM_ANDROID
extern "C" JNIEXPORT void  JNICALL Java_com_epicgames_ue4_GameActivity_JavaToCAppCopyrightVerifyCallback(JNIEnv * env, jclass clazz, int Result)
{
...
#if PLATFORM_ANDROID
extern "C" JNIEXPORT void  JNICALL Java_com_epicgames_ue4_GameActivity_JavaToCSetWifiP2PDeviceNameCallback(JNIEnv * env, jclass clazz, int Result)
{
...
#if PLATFORM_ANDROID
extern "C" JNIEXPORT void  JNICALL Java_com_epicgames_ue4_GameActivity_JavaToCConnectWifiCallback(JNIEnv * env, jclass clazz, int Result)
{
